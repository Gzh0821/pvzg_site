...
Si quieres crear lineas de niveles de plantas, insignias de nivel o paginas de nivel en el almanaque, sigue con [Niveles de plantas](./gp-next-plant-level.md).
