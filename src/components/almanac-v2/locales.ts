...
const text = {
  zh: {
    ...
    userView: '玩家图鉴',
    developerView: '开发者数据',
    developerLoading: '正在加载当前实体的数据…',
    developerError: '开发者数据加载失败。',
    retry: '重试',
    references: '数据引用',
    featureData: 'Feature',
    propsData: 'Props',
    almanacData: 'Almanac',
    unavailable: '未提供',
    requestedReference: '引用',
    resolvedAlias: '解析为',
    dataVersion: '数据版本',
    searchFields: '搜索字段名、路径或值',
    clearSearch: '清除搜索',
    noMatches: '没有匹配的字段。',
    copyPath: '复制路径',
    copyValue: '复制值',
    copied: '已复制',
    developerWarning: '数据提示',
  },
  en: {
    ...
    viewMode: 'Almanac view',
    userView: 'Player almanac',
    developerView: 'Developer data',
    developerLoading: 'Loading data for this entity…',
    developerError: 'Developer data could not be loaded.',
    retry: 'Retry',
    ...
    resolvedAlias: 'Resolved as',
    dataVersion: 'Data version',
    searchFields: 'Search field names, paths, or values',
    clearSearch: 'Clear search',
    noMatches: 'No matching fields.',
    copyPath: 'Copy path',
    copyValue: 'Copy value',
    copied: 'Copied',
    developerWarning: 'Data notes',
  },
};
...
export type AlmanacText = ReturnType<typeof getAlmanacText>;
