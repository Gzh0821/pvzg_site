...
Файл `StoreCommodityFeatures.json` содержит информацию о товарах магазина, включая пять массивов: `Plants`, `Upgrade`, `Gem`, `Coin` и `Zen`, представляющих разные типы товаров.
...
Массив `Zen` содержит информацию о товарах для Сада-Дзен. Структура совпадает с `Gem` и `Coin`.

| Свойство                 | Описание                                                        |
| ------------------------ | --------------------------------------------------------------- |
| _CommodityType_          | Фиксированное значение "zen"                                   |
| CommodityCount           | Количество получаемых ресурсов Сада-Дзен                        |
| **CurrencyType**         | Тип валюты ("кристалл" или "монета")                         |
| CurrencyRequired         | Необходимое количество валюты                                   |
| _StackLevel_             | Уровень Товара-пака                                             |
| **CommodityDisplayName** | Отображаемое название товара (мультиязычное)                    |
