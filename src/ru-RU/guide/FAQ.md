...
О: Да. GP-Next поддерживает JSON-моды данных и переводов, JavaScript-моды, а также новые растения, зомби и ресурсы через совместимые расширения. JSON устанавливается напрямую; JavaScript нужно вручную включить в консоли. См. [руководство по модам](./mod/gp-next.md).
