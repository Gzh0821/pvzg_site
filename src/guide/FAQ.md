...
> [!note]
> 请在游玩或提问前阅读此 FaQ，此 FaQ 适用于 0.7.X 版本
>
...
A: 可以。GP-Next 支持 JSON 数据和语言模组，也支持 JavaScript 玩法模组及带前置框架的新植物、僵尸和资源内容。纯 JSON 可直接安装；JS 目前需要从控制台手动开启。先看[模组安装指南](./mod/gp-next.md)，作者可查看 [API 文档](./mod/gp-next-api.md)。
