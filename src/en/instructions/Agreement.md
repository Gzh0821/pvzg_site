...
1.  **Asset Copyright**
    All art resources, music, sound effects, character images (plants, zombies, etc.), and related design elements contained in this Project belong to the original copyright holders, **Electronic Arts / PopCap Games**, and other relevant rights holders.
...
1.  **Personal Use License**
    You are granted a non-exclusive, non-transferable license to download, install, and run this Project on your personal device for entertainment.

2.  **Modification and Distribution Rules**
    ...
    -   **Release of Modified Versions**: If you release a modified version based on the Web build, it must be clearly marked as an "Unofficial Modified Version" and must not use official logos that may cause misleading endorsement.
