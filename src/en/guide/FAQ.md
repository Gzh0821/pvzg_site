...
> [!note]
> Please read the FaQ before playing or asking questions. This FaQ is Valid till 0.7.X version
>
...
A: Yes. GP-Next supports JSON data/language mods, JavaScript gameplay mods, and new plants, zombies and assets through compatible frameworks. JSON mods can be installed directly; JavaScript currently requires manual console activation. See [mod installation](./mod/gp-next.md) and the [author API](./mod/gp-next-api.md).
