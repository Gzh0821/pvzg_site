---
title: GE Patcher Tutorial(Old Format) 
icon: wrench
pageInfo: false
index: true
order: 3
...
> [!warning]
> The gePatcher introduced in this tutorial applies only to versions `0.3.X`-`0.7.1`. For version 0.7.1 and above, please use the more powerful `GP-Next`. See [here](gp-next.md).
